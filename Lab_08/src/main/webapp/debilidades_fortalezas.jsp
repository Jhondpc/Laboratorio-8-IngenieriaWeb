<%@ page import="com.example.lab_08.model.Beans.Elemento" %>
    ...
    <body class="main-layout">
        ...
        <header>
                                    ...
                                    <div class="limit-box">
                                        <nav class="main-menu">
                                            <ul class="menu-area-main">
                                                ...
                                                <li> <a href="<%=request.getContextPath()%>/index">Ir al menú principal</a> </li>
													...
													<tr>
														...
														<td>
															...
															<a type="button" class="btn btn-primary"
															   href="<%=request.getContextPath()%>/AdminServlet?action=editar&id=<%=elemento.getIdElemento()%>">
            ...
            <div class="col-5 ">
                ...
                <figure><img src="images/drago.png" /></figure>
            </div>

            <div class="row" "text-img">

            <figure><img src="images/repti.png" /></figure>
