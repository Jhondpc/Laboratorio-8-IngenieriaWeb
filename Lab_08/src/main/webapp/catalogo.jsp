                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a type="button" class="btn btn-primary"
                                                               href="<%=request.getContextPath()%>/ObjetoServlet?accion=editar&id=<%=objetos.getIdInventarioObjetos()%>">
                                                        ...
                                                        <td>
                                                            ...
                                                            <a
                                                                    ...
                                                                    class="btn btn-danger" href="<%=request.getContextPath()%>/ObjetoServlet?accion=borrar&id=<%=objetos.getIdInventarioObjetos()%>"
