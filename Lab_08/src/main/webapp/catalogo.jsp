                                            ...
                                            <div class="container-fluid">
                                                <div class="row" >
                                                    <div class="col-3">
                                                        ...
                                                        <a class="btn btn-danger" href="<%=request.getContextPath()%>/ObjetoServlet?accion=agregarObjeto"
                                                           role="button">Añadir nuevo Objeto</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a type="button" class="btn btn-primary"
                                                               href="<%=request.getContextPath()%>/ObjetoServlet?action=editar&id=<%=objetos.getIdInventarioObjetos()%>">
                                                        ...
                                                        <td>
                                                            ...
                                                            <a
                                                                    ...
                                                                    class="btn btn-danger" href="<%=request.getContextPath()%>/ObjetoServlet?action=borrar&id=<%=objetos.getIdInventarioObjetos()%>"
