                                    ...
                                    <section class="section profile" style="padding-top: 30px">
                                        <div class="container">
                                            <div class="container-fluid">
                                                ...
                                                <br>
                                                <div></div>
                                                <form  method="post" action="<%=request.getContextPath()%>/HeroeServlet?accion=buscar"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a type="button" class="btn btn-primary"
                                                                   href="<%=request.getContextPath()%>/HeroeServlet?accion=editar&id=<%=heroes.getIdHeroes()%>">
                                                            ...
                                                            <td>
                                                                ...
                                                                <a
                                                                        ...
                                                                        class="btn btn-danger" href="<%=request.getContextPath()%>/HeroeServlet?accion=borrar&id=<%=heroes.getIdHeroes()%>"
