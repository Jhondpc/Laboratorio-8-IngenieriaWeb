                                    ...
                                    <div class="limit-box">
                                        <nav class="main-menu">
                                            <ul class="menu-area-main">
                                                ...
                                                <li> <a href="heroes.jsp">Héroes</a> </li>
                                                <li> <a href="enemigo.jsp">Enemigos</a> </li>
                                                <li> <a href="hechizos.jsp">Hechizos</a> </li>
                                                <li> <a href="catalogo.jsp">Catálogo de Obejtos</a> </li>
