                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a type="button" class="btn btn-primary"
                                                           href="<%=request.getContextPath()%>/EnemigoServlet?action=editar&id=<%=enemigos.getIdEnemigos()%>">
                                                    ...
                                                    <td>
                                                        ...
                                                        class="btn btn-danger" href="<%=request.getContextPath()%>/EnemigoServlet?action=borrar&id=<%=enemigos.getIdEnemigos()%>"
