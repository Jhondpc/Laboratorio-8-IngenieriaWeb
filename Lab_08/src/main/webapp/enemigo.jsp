                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tr style="align-content: center">
                                                ...
                                                <th>Clase</th>
                                                <th>Ataque</th>
                                                <th>Experiencia por derrota</th>
                                                <th>Obejto dejado</th>
                                                <th>Probabilidad de dejar objeto</th>
                                            ...
                                            <tr>
                                                <td><%=enemigos.getIdEnemigos()%>
                                                </td>
                                                <td><%=enemigos.getNombre()%>
                                                </td>
                                                <td><%=enemigos.getClase()%>
                                                </td>
                                                <td><%=enemigos.getAtaque()%>
                                                </td>
                                                ...
                                                <td>
                                                    <a type="button" class="btn btn-primary"
                                                       href="<%=request.getContextPath()%>/EnemigoServlet?accion=editar&id=<%=enemigos.getIdEnemigos()%>">
                                                ...
                                                <td>
                                                    ...
                                                    <a
                                                            ...
                                                            class="btn btn-danger" href="<%=request.getContextPath()%>/EnemigoServlet?accion=borrar&id=<%=enemigos.getIdEnemigos()%>"
