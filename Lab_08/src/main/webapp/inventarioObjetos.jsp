...
<%@ page import="com.example.lab_08.model.Beans.InventarioHeroe" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>

<%
    ArrayList<InventarioHeroe> listaInventarioHeroe = (ArrayList<InventarioHeroe>) request.getAttribute("listaInventario");
%>
                                    ...
                                    <div class="container-fluid">
                                        <div class="row" >
                                            <div class="col-3">
                                                ...
                                                <a class="btn btn-danger" href="<%=request.getContextPath()%>/HeroeServlet"
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                            <%
                                                for (InventarioHeroe invHeroe : listaInventarioHeroe) { %>
                                            <tr>

                                                <td><%=invHeroe.getNombreHeroe()%>
                                                </td>
                                                <td><%=invHeroe.getNombreObjeto()%>
                                                </td>
                                                <td><%=invHeroe.getUso()%>
                                                </td>
                                                <td><%=invHeroe.getPeso()%>
                                                </td>
                                                <td><%=invHeroe.getCantObjetos()%>
                                                </td>
